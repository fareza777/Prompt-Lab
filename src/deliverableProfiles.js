...
export function validateFinishedOutput(content = "", profile = "general") {
  ...
  const headings = cleaned
    ...
    .filter(Boolean);
  if (new Set(headings).size < headings.length) warnings.push("repeated_heading");
