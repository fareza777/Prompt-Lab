...
const id = {
  ...
  "result.viewPrompt": "Kontrol lanjutan",
  "result.copyPrompt": "Salin instruksi internal",
  "result.improvePrompt": "Atur hasil berikutnya",
  "result.comparePrompt": "Bandingkan versi",
  ...
  "result.workingHint":
    "PromptLab sedang membaca konteks dan menyiapkan hasil final.",
  ...
  "firstrun.build.body":
    "PromptLab membaca konteks, mengerjakan permintaanmu, lalu menampilkan hasil lengkap dalam satu alur.",
  "firstrun.build.point1": "Hasil langsung muncul di PromptLab tanpa perlu pindah aplikasi",
...
const en = {
  ...
  "result.viewPrompt": "Advanced controls",
  "result.copyPrompt": "Copy internal instruction",
  "result.improvePrompt": "Adjust the next result",
  "result.comparePrompt": "Compare versions",
  ...
  "result.workingHint":
    "PromptLab is reading the context and preparing the final result.",
  ...
  "firstrun.build.body":
    "PromptLab reads the context, completes your request, and shows the finished work in one flow.",
  "firstrun.build.point1": "The result appears directly in PromptLab—no app switching",
