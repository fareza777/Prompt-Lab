...
const id = {
  ...
  "canvas.subtitle":
    "Mulai dari ide, catatan, foto, atau file. PromptLab mengubahnya langsung menjadi hasil kerja yang bisa kamu lanjutkan.",
  "canvas.placeholder":
  ...
  "result.viewPrompt": "Lihat prompt",
  "result.copyPrompt": "Salin prompt",
  "result.improvePrompt": "Perbaiki prompt",
  "result.comparePrompt": "Bandingkan prompt",
  "result.run": "Jalankan sekarang",
  "result.running": "Menjalankan…",
  "result.runHint":
    "Jalankan prompt ini di sini dan dapatkan hasil jadinya, tanpa perlu menyalin ke aplikasi lain.",
  "result.tabPrompt": "Prompt",
  "result.tabOutput": "Hasil jadi",
  "result.backToPrompt": "Lihat prompt",
  "result.runWorking": "Sedang mengerjakan permintaanmu",
  "result.runWorkingHint":
    "Menjalankan prompt biasanya 30–60 detik karena isinya ditulis penuh. Biarkan halaman ini terbuka.",
  "result.runFailed": "Gagal menjalankan prompt. Coba lagi sebentar.",
  "result.working": "Sedang menyiapkan hasil kerjamu",
  "result.workingHint":
    "PromptLab sedang membaca konteks dan menyusun instruksi terbaik sebelum membuat hasil final.",
...
const en = {
  ...
  "canvas.subtitle":
    "Start with an idea, note, photo, or file. PromptLab turns it directly into work you can continue.",
  "canvas.placeholder":
  ...
  "result.viewPrompt": "View prompt",
  "result.copyPrompt": "Copy prompt",
  "result.improvePrompt": "Improve prompt",
  "result.comparePrompt": "Compare prompt",
  "result.run": "Run it now",
  "result.running": "Running…",
  "result.runHint":
    "Run this prompt here and get the finished result, without copying it into another app.",
  "result.tabPrompt": "Prompt",
  "result.tabOutput": "Finished result",
  "result.backToPrompt": "View prompt",
  "result.runWorking": "Working on your request",
  "result.runWorkingHint":
    "Running a prompt usually takes 30–60 seconds because the content is written out in full. Keep this page open.",
  "result.runFailed": "Could not run the prompt. Please try again shortly.",
  "result.working": "Preparing your finished work",
  "result.workingHint":
    "PromptLab is reading the context and preparing the strongest instruction before producing the final result.",
