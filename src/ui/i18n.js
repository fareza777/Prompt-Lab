...
const id = {
  "app.name": "PromptLab",
  "app.tagline": "Penyusun prompt AI",
  ...
  "canvas.subtitle":
    "Tulis permintaanmu, atau lampirkan foto, tangkapan layar, dan file. PromptLab menyusunnya jadi prompt terstruktur — lalu bisa langsung dijalankan di sini.",
  "canvas.placeholder":
...
const en = {
  ...
  "canvas.subtitle":
    "Describe what you need, or attach photos, screenshots, and files. PromptLab turns it into a structured prompt — then runs it for you right here.",
  "canvas.placeholder":
